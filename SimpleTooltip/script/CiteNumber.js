 ...
 * <span>
 * 转变成
 * <span data-ct="foo" class="tooltip" data-ref="foo">
 *     <a href="#aaa">[1]</a>
 * </span>
 *
 * 或者把
 ...
 * <span>
 * 转变成
 * <span data-dt="bar" class="tooltip" data-ref="bar">
 * </span>
 */
$(document).ready(function () {
    /* 1.a 引用排序: 按照引用在 HTML 文档中出现顺序, 把引用的 data-ref 生成无重复值的数
           组 citesOrdered */
    let cites = $("[data-ct]");
    ...
    /* 1.b 描述排序: 按照引用在 HTML 文档中出现顺序, 把引用的 data-ref 生成无重复值数组
           descsOrdered */
    let descs = $("[data-dt]");
    let descsOrdered = [];
    ...
    for (let i = 0; i < descs.length; i++) {
        ...
        // Add the class name "tooltip", 因为SimpleTooltip.js是以类名为tooltip来选
        // 择的
